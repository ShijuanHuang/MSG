...
# Data root /data2/hsj/CC-ReId/CCReID_datasets
_C.DATA.ROOT = '../CC-ReId/CCReID_datasets' 
# Number of instances
_C.DATA.NUM_INSTANCES = 2 #8
# Batch size during testing
_C.DATA.TEST_BATCH = 1 #128
...
# Misc options
# ---------------------------------------------------------------------------- #
# Path to checkpoint and saved log of trained model /data2/hsj/CC-ReId/CCReID_datasets
_C.OUTPUT_DIR = "/logs"
